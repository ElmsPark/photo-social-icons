...
class Photo_Social_Icons_Widget extends WP_Widget {
  ...
  /**
	...
	function __construct() {
		...
		$this->profiles = array(
			'flickr' => array(
				...
				'pattern' => '<li class="social-flickr"><a href="%s" %s>Flickr</a></li>',
			...
			'vimeo' => array(
				...
				'pattern' => '<li class="social-vimeo"><a href="%s" %s>Vimeo</a></li>',
				'background_positions' => array(
					'24' => '-168px 0',
					'32' => '-224px 0',
					'48' => '-336px 0',
		...
		$widget_ops = array(
			'classname'	  => 'photo-social-icons',
			'description' => __( 'Displays select social icons.', 'ssiw' ),
		);

		$control_ops = array(
			'id_base' => 'photo-social-icons',
			#'width'   => 505,
			#'height'  => 350,
		);

		$this->WP_Widget( 'photo-social-icons', __( 'Photo Social Icons', 'ssiw' ), $widget_ops, $control_ops );
	...
	function css() {
		...
		/** The CSS to output */
		$css = '.photo-social-icons {
			overflow: hidden;
		}
		.photo-social-icons .alignleft, .photo-social-icons .alignright {
			margin: 0; padding: 0;
		}
		.photo-social-icons ul li {
		...
		.photo-social-icons ul li a,
		.photo-social-icons ul li a:hover {
		...
		foreach ( (array) $this->profiles as $profile => $data ) {
			...
			$css .= '.photo-social-icons ul li.social-' . $profile . ' a,
			.photo-social-icons ul li.social-' . $profile . ' a:hover {
 ...
 * Widget Registration.
 *
 * Register Photo Social Icons widget.
 *
 */
function ssiw_load_widget() {

	register_widget( 'Photo_Social_Icons_Widget' );
